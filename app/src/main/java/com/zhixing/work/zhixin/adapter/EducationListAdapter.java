...
public class EducationListAdapter extends RecyclerView.Adapter<EducationListAdapter.ViewHolder> {
    public List<Resume.EducationOutputsBean> getContactList() {
        return list;
    }
    ...
    public EducationListAdapter(List<Resume.EducationOutputsBean> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View convertView = mInflater.inflate(R.layout.item_education_list,
                parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Resume.EducationOutputsBean education= list.get(position);
