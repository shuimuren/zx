...
public class ResumeProjectAdapter extends RecyclerView.Adapter<ResumeProjectAdapter.ViewHolder> {
    ...
    public void setList(List<Resume.ProjectBackgroundOutputsBean> list) {
        this.list = list;
        notifyDataSetChanged();
    }

    private List<Resume.ProjectBackgroundOutputsBean> list;

    private Context context;
    private LayoutInflater mInflater;

    public ResumeProjectAdapter(List<Resume.ProjectBackgroundOutputsBean> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View convertView = mInflater.inflate(R.layout.item_project_resume,
                parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final Resume.ProjectBackgroundOutputsBean bean = list.get(position);
        holder.name.setText(bean.getProjectName());
    ...
    private void setPublic(RequestBody body, String id, final CheckBox cb) {
        OkUtils.getInstances().httpatch(body, context, RequestConstant.PROJECT_BACKGROUND + "?Id=" + id, JavaParamsUtils.getInstances().resumeAvatar(), new TypeToken<EntityObject<Boolean>>() {
