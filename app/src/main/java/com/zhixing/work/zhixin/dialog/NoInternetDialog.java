...
public class NoInternetDialog extends BaseDialog {
	...
	public NoInternetDialog(Context ctx) {
		this(ctx, null);
	}

	public NoInternetDialog(Context ctx, String loadingMsg) {
		this(ctx, loadingMsg, false, null);
	}

	public NoInternetDialog(final Context ctx, String loadingMessage, boolean canNotCancel, String backTipMsg) {
		super(ctx);
