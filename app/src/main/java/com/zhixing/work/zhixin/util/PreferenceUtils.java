...
public class PreferenceUtils {
	...
	public synchronized static void putObject(String key, Object value) {
		mCacheItem.put(key, value);
	}

	public synchronized static Object getObject(String key, Object defaultValue) {
		Object value = null;
		try {
	...
	public synchronized static String getString2(String key) {
//		String value = (String) mCacheItem.get(key);
//		if (!TextUtils.isEmpty(value)) {
//			return value;
//		}
		String value = "";
		SharedPreferences sp = getAppSettingPreference2();
		value = sp.getString(key, null);
//		if (!TextUtils.isEmpty(value)) {
//			mCacheItem.put(key, value);
//		}
	 ...
	 * @return
	 */
	private static SharedPreferences getAppSettingPreference2() {
		Context ctx = getContext();
		// if not set init preference name then the preference name is the
		// packagename
		if (TextUtils.isEmpty(PREFERENCES_NAME)) {
		...
		return ctx.getSharedPreferences(PREFERENCES_NAME, Context.MODE_MULTI_PROCESS);
	}
