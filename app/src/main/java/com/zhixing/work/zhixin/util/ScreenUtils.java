...
//		this.requestWindowFeature(Window.FEATURE_NO_TITLE); 
     ...
     * 将自己的view插入状态栏底部
     */
    public static void setBackOnStatusBar(Activity activity) {
        WindowManager.LayoutParams attrs1 = activity.getWindow().getAttributes();
        attrs1.flags &= ~WindowManager.LayoutParams.FLAG_FULLSCREEN;
        activity.getWindow().setAttributes(attrs1);
