...
//                        .isDialog(true)//是否显示为对话框样式
    ...
    private void addEvent(String Name, String Date, String Intro, String Image) {
        OkUtils.getInstances().httpPost(context, JavaConstant.CompanyHistory, JavaParamsUtils.getInstances().AddCompanyHistory
    ...
    private void editEvent(String id, String Name, String Date, String Intro, String Image) {
        ...
        OkUtils.getInstances().httpPut(body,context, JavaConstant.CompanyHistory, JavaParamsUtils.getInstances().editCompanyHistory
