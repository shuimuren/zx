...
public class PersonalQualificationActivity extends BaseTitleActivity {
    ...
    private void takeAPicture() {
        ...
        //intentCamera.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(photoFile));
        intentCamera.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider7.getUriForFile(PersonalQualificationActivity.this, photoFile));
    ...
    private void putCertification(RequestBody body) {
        OkUtils.getInstances().httpatch(body, context, RequestConstant.ID_CARD, JavaParamsUtils.getInstances().IdCard(), new TypeToken<EntityObject<Boolean>>() {
