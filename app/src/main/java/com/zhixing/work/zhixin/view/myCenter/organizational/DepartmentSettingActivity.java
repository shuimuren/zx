...
public class DepartmentSettingActivity extends BaseTitleActivity {
    ...
    private void modify(String json) {
        ...
        OkUtils.getInstances().putJson(context, JavaConstant.Department, json, new TypeToken<EntityObject<Boolean>>() {
    ...
    private void deleteData(int id) {
        OkUtils.getInstances().httpDelete(context, JavaConstant.Department + "?departmentId=" + id, JavaParamsUtils.getInstances().deleteProduct(), new TypeToken<EntityObject<Boolean>>() {
        }.getType(), new ResultCallBackListener<Boolean>() {
            @Override
