...
public class EvaluatingView extends View {
    ...
    private void initSize(Context context) {
        n = 5;  //五条边
        R = dp2pxF(context, 60);  //半径暂时设为100dp
        intervalCount = 3;   //有3层
    ...
    private void initPoints() {
        ...
        for (int i = 0; i < intervalCount; i++) {
            ...
            for (int j = 0; j < n; j++) {
                float r = R * ((float) (3 - i) / intervalCount);  //每一圈的半径都按比例减少
    ...
    private void initPaint(Context context) {
        ...
        textPaint.setColor(Color.parseColor("#7d4a14"));
    ...
    private void drawPolygon(Canvas canvas) {
        ...
        for (int i = 0; i < intervalCount; i++) {
            switch (i) {
                case 0:
                    linePaint.setColor(Color.parseColor("#bd8633"));
                    widR = R;
                    break;
                case 1:
                    linePaint.setColor(Color.parseColor("#a7752e"));
                    widR = R * 2 / 3;
                    break;
                case 2:
                    linePaint.setColor(Color.parseColor("#8f5d28"));
                    widR = R / 3;
                    break;
            }
            canvas.drawCircle(0, 0, widR, linePaint);
...
//        canvas.drawPath(path, linePaint);
    ...
    private void drawAbilityLine(Canvas canvas) {
        ...
        linePaint.setColor(Color.parseColor("#AA966743"));
        linePaint.setStyle(Paint.Style.FILL);  //设置实心

        Paint paint = new Paint();
        paint.setStrokeWidth(dp2px(getContext(), 2f));
